...
contextBridge.exposeInMainWorld("desktopShell", {
  ...
  getPetBounds: () => ipcRenderer.invoke("desktop-shell:get-pet-bounds"),
  movePetWindow: (x, y) => ipcRenderer.send("desktop-shell:move-pet-window", { x, y }),
  setPetState: (stateKey) => ipcRenderer.invoke("desktop-shell:set-pet-state", stateKey),
